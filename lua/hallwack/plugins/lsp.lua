return {
  ...
  config = function()
    ...
    if not (ok_lspzero and ok_lsp and ok_mason and ok_mason_lsp and ok_cmp and ok_lspkind and ok_luasnip and ok_null_ls and ok_lspsaga and ok_ts and ok_rust_tools) then return end
    ...
    lsp.on_attach(function(client, bufnr)
      ...
      buf_set_keymap("n", "<leader>fr", "<Cmd>lua vim.lsp.buf.format({ async = true })<CR>",
      ...
      buf_set_keymap("n", "<leader>cd", "<Cmd>Lspsaga show_line_diagnostics<CR>",
        { noremap = true, silent = true })
      buf_set_keymap("n", "<leader>cr", "<Cmd>Lspsaga show_cursor_diagnostics<CR>",
        { noremap = true, silent = true })
